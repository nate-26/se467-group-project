...
<div id="errorSplash" class="error-splash hide">
  ...
  <div>Please check your card details and input the correct information.</div>
    ...
    <form id="custInfo">
      ...
      <div><input type="text" id="custFName" maxlength="30" placeholder="John" required><br></div>
     

      
      <div><br><label class="text-white" for="custLName">Last Name:</label><br></div>
      ...
      <div><input type="text" id="streetAddr" placeholder="308 Negra Arroyo Lane" required><br><br></div>
    

    
      <div><label class="text-white" for="cityAddr">City:</label><br></div>
      <div><input type="text" id="cityAddr" placeholder="Albuquerque" required><br><br></div>
